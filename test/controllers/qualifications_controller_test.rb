...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { instructor_id: @qualification.instructor_id, title: @qualification.title } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { instructor_id: @qualification.instructor_id, title: @qualification.title } }
